...
Tops = Frame(root, width=1350, height=50, bd=8, bg="lightblue")
Tops.pack(side=TOP)

f1 = Frame(root, width=600, height=600, bd=8, bg="white")
f1.pack(side=LEFT)
f2 = Frame(root, width=300, height=700, bd=8, bg="lightblue")
f2.pack(side=RIGHT)
...
lbl_information = Label(Tops, font=('arial', 45, 'bold'), text="Employee Payment Management System ", relief=GROOVE,  bd=10, bg="lightpink", fg="Black")
...
def InformationEntry():
    ...
    txtPaymentSlip.insert(END, "PsID:\t\t" + PsID.get() + "\n\n")
...
labelFirstName = Label(fla, text="Full Name", font=('arial', 16, 'bold'), bd=20, fg="black", bg="lightblue").grid(row=0, column=0)

labelAddress = Label(fla, text="Home Address", font=('arial', 16, 'bold'), bd=20, fg="black", bg="lightblue").grid(row=0, column=2)

labelCompanyAgency = Label(fla, text="Payslip ID", font=('arial', 16, 'bold'), bd=20, fg="black", bg="lightblue").grid(row=1,
                                                                                                              column=0)
labelPhoneNumber = Label(fla, text="Phone Number", font=('arial', 16, 'bold'), bd=20, fg="black", bg="lightblue").grid(row=1,
                                                                                                               column=2)
labelHoursWorked = Label(fla, text="Hours Worked", font=('arial', 16, 'bold'), bd=20, fg="black", bg="lightblue").grid(
    row=2, column=0)
labelHourlyRate = Label(fla, text="Hourly Rate", font=('arial', 16, 'bold'), bd=20, fg="black", bg="lightblue").grid(
    row=2, column=2)
labelTax = Label(fla, text="Tax", font=('arial', 16, 'bold'), bd=20, anchor='w', fg="black", bg="lightblue").grid(row=3,
                                                                                                                column=0)
labelOverTime = Label(fla, text="OverTime", font=('arial', 16, 'bold'), bd=20, fg="black", bg="lightblue").grid(row=3,
                                                                                                              column=2)
labelGrossPay = Label(fla, text="GrossPay", font=('arial', 16, 'bold'), bd=20, fg="black", bg="lightblue").grid(row=4,
                                                                                                              column=0)
labelNetPay = Label(fla, text="Net Pay", font=('arial', 16, 'bold'), bd=20, fg="black", bg="lightblue").grid(row=4,
                                                                                                           column=2)
...
txtPsID = Entry(fla, textvariable= PsID, font=('arial', 16, 'bold'), bd=16, width=22, justify='left')
txtPsID.grid(row=1, column=1)
...
payslip = Label(f2, textvariable=DateOfOrder, font=('arial', 21, 'bold'), fg="black", bg="lightpink").grid(row=0,
                                                                                                           column=0)
